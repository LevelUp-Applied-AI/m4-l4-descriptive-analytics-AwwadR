...
Main columns include: `student_id`, `department`, `semester`, `course_load`, `study_hours_weekly`, `gpa`, `attendance_pct`, `has_internship`, `commute_minutes`, and `scholarship`.
...
### Internship and GPA
An independent samples t-test compared GPA between students with and without internships. The test returned **t = 14.2288** and **p < 0.001**. This result is statistically significant. **Cohen’s d = 0.6898**, indicating a **medium effect size**. This suggests that students with internships tend to have higher GPAs than students without internships.
